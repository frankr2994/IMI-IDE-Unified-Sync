...
class SkillEngine {
  ...
  _ensureDefaults() {
    const defaults = [
      ...
      { id: 'sk_imi_info',  name: 'What is IMI',           pattern: '^\\s*(what is|explain|describe|tell me about)\\s+(imi|this app|this program|this tool)\\s*[?!]?\\s*$', type: 'cached', handler: null, cachedResponse: 'IMI (Integrated Merge Interface) is your AI orchestration desktop app. It splits every task between a Brain (plans) and a Coder (executes) to minimize token usage. It controls your browser, desktop, and codebase simultaneously.', desc: 'Cached IMI description — 0 tokens' },
